%macro set_excel(inds,keta);
	...
	%if &keta.=1 %then %do;
		...
		%let keta4=8.2;/*平均値、四分位値、中央値*/
		%let keta5=8.1;/*最小値、最大値*/
	%end;
	%if &keta.=2 %then %do;
		%let keta1=0.001;/*標準偏差*/
		%let keta2=8.2;/*標準偏差*/
		%let keta3=0.01;/*平均値、四分位値、中央値*/
		%let keta4=8.1;/*平均値、四分位値、中央値*/
		%let keta5=8.;/*最小値、最大値*/
	%end;
	%if &keta.=3 %then %do;
		...
		%let keta4=8.3;/*平均値、四分位値、中央値*/
		%let keta5=8.2;/*最小値、最大値*/
	%end;
		%if &keta.=4 %then %do;
		%let keta1=0.000001;/*標準偏差*/
		%let keta2=8.5;/*標準偏差*/
		%let keta3=0.00001;/*平均値、四分位値、中央値*/
		%let keta4=8.4;/*平均値、四分位値、中央値*/
